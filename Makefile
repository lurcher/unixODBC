...
pkglibexecdir = $(libexecdir)/unixODBC
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in $(srcdir)/unixodbc_conf.h.in \
...
CONFIG_HEADER = config.h unixodbc_conf.h
CONFIG_CLEAN_FILES =
...
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) \
	$(LISP)config.h.in unixodbc_conf.h.in
...
unixodbc_conf.h: stamp-h2
	@test -f $@ || rm -f stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) stamp-h2

stamp-h2: $(srcdir)/unixodbc_conf.h.in $(top_builddir)/config.status
	@rm -f stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status unixodbc_conf.h

distclean-hdr:
	-rm -f config.h stamp-h1 unixodbc_conf.h stamp-h2
